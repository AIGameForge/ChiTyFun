...
中文/注音打字練習小遊戲（落字版），支援關卡、計分、音效與背景音樂。

## 開始玩

- **線上版（GitHub Pages）**：部署完成後即可用 `https://aigameforge.github.io/ChiTyFun/` 開啟
- **本機**：直接用瀏覽器開 `index.html`（若音效被瀏覽器限制，先點一下頁面再開始）

## 操作

- **Enter**：送出命中
- **Space**：發射「大絕」（需有大絕且輸入框為空、未處於 IME 組字中）
- **Esc**：暫停/繼續

## 專案檔案

- `index.html` / `style.css` / `main.js`
- `hit.wav` / `dead.wav` / `laser.wav`
- `pixel_loop.wav`
